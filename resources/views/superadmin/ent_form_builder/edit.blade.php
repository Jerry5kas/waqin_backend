    ...
    <div class="card-body">
        <div class="row">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{ $result['FrmData']->name }}" name="FormName" placeholder="ex: Basic Details">
            </div>

            <div class="mb-3">
                <label class="form-label">Select Business</label>
                <select class="js-example-basic-multiple form-control" id="Business" name="Business[]" multiple="multiple">
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        const $fbTemplate1 = $('#build-wrap_edit');
        ...
        const formData = @json($result['FrmData']->form);

        if (formData) {
            const formBuilder = $fbTemplate1.formBuilder({
                formData: formData,
            ...
            $('#saveData').click(function () {
                if (formBuilder) {
                    ...
                    $.post("{{ route('updateentformbuilder') }}", {
                        FormName: FormName,
