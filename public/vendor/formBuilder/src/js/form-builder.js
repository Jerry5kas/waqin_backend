          ...
          function() {
              ...
              class pe {
                  constructor(e, t) {
                      ...
                      this.classConfig = jQuery.extend({}, pe.controlConfig[this.type] || {}, pe.controlConfig[o] || {}), this.subtype && (e.type = this.subtype), this.required && (e.required = "required", e["aria-required"] = "true"), this.disabled && (e.disabled = "disabled"), this.config = e, this.configure()
                  }
              ...
              function ut(e, t, o) {
                  ...
                  const K = function(e, t, r) {
                      ...
                      se = function(t, r, o) {
                          ...
                          if (![].some((e => !0 === e))) {
                              ...
                              "label" !== t || e.disableHTMLLabels ? "textarea" === r.type && "value" === t ? a += b("textarea", n, d).outerHTML : (d.value = n, d.type = "text", a += `<input ${L(d)}>`) : (d.contenteditable = !0, a += b("div", n, d).outerHTML);
                      ...
                      ce = function(t, r) {
                          ...
                          if (fe(T), T.data("fieldData", {
                              ...
                              let r = !1;
                              x.children(t).length ? D = x.children(t) : (D = b("div", null, {
                                  id: `${k.id}-row`,
                                  className: `row row-${l.rowUniqueId} ${ot}`
                              }), r = !0), j && E && (C.attr("id", D.id), C.attr("class", D.className), C.attr("style", ""), C.attr("data-row-id", l.rowUniqueId), D = C);
                              const n = b("div", null, {
                                  id: `${k.id}-cont`,
                                  className: `${l.columnSize} ${nt}`
                              });
                              j && S && ("true" === C.attr("prepend") ? o(n).prependTo(D) : o(n).insertAfter(`#${C.attr("appendAfter")}`)), S || o(n).appendTo(D), !j && r && T.after(D), T.appendTo(n), r && (he(D), ue(), pe(D), e.enableColumnInsertMenu && (o(D).off("mouseenter"), o(D).on("mouseenter", (function(e) {
                                  xe(o(e.currentTarget))
                              })), o(D).off("mouseleave"), o(D).on("mouseleave", (function(e) {
                                  Ce(o(e.currentTarget))
                              })))), xe(D, !0), l.addedDefaultColumnClass && T.attr("addedDefaultColumnClass", !0), p.tmpCleanPrevHolder(o(y))
                          }
                  ...
                  function pe(e) {
                      ...
                      t.insertAfter(o(e)), he(t), x.find(at + ":last-of-type").removeClass(lt)
                  }

                  function me() {
                      x.children(dt).remove(), x.children(at).each(((e, t) => {
                          pe(o(t))
                      })), x.find(at + ":last-of-type").removeClass(lt)
                  }
